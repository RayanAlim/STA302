#### Preamble ####
# Purpose: Downloads and saves the data from Open Data Toronto: Data is the Crime in neighbourhoods dataset
...
#### Save data ####
write_csv(raw_profiles_data,
          "inputs/data/unedited_neighbourhood_data.csv")
